...
class ActionRegisterFragment : function_arrow_back() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnEnviar.setOnClickListener {
            ...
            when {
                ...
                // Caso uma data esteja preenchida e a outra não
                ...
                // Se ambas preenchidas, validar ordem
                (dataInicio.isNotEmpty() && dataFim.isNotEmpty()) -> {
                    ...
                    if (!datasValidas) {
                        ...
                        edtEndDate.requestFocus()
                    } else if (pilarSelecionado == null) {
                        Toast.makeText(requireContext(), "Pilar não selecionado", Toast.LENGTH_SHORT).show()
                    } else {
                        salvarAction(titulo, descricao, responsavel, orcamento, dataInicio, dataFim)
                    }
                }
    ...
    private fun salvarAction(
        ...
        Toast.makeText(requireContext(), "Ação pendente de aprovação pelo Coordenador.", Toast.LENGTH_SHORT).show()
